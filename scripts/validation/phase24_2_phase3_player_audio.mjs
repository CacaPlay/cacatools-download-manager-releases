...
const checks = [
  ...
  ['Spotify sigue desactivado y la extensión conserva su ID', rust.includes('SPOTIFY_DISABLED_MESSAGE') && extensionBridge.includes('aonppfnabjnicjjeoofkfjofolfibggp') && read('extension/README.md').includes('aonppfnabjnicjjeoofkfjofolfibggp')],
