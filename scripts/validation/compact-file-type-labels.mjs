...
assert.match(rustSource, /extension: String/, 'el snapshot nativo debe publicar la extensión real');
assert.match(rustSource, /snapshot_extension\(output_mode\.as_deref\(\), &destination_path\)/, 'el snapshot debe derivar el formato desde el modo de salida o el archivo final');
