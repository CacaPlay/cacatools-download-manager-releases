...
ARIA2 = ROOT / "src-tauri/src/downloads/aria2.rs"
...
def architecture_blockers() -> list[str]:
    ...
    aria2 = ARIA2.read_text(encoding="utf-8")
    start = worker.index("fn run_download_worker_inner_with_engine")
    ...
    if "ExternalProcessRegistry" in process and "lease" not in process.lower():
        ...
        pass
    if "continue=true" in aria2 or "--continue" in aria2:
