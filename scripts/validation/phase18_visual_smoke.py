...
OUT = ROOT / 'docs' / 'screenshots' / 'phase18'
REPORT = ROOT / 'docs' / 'tests' / 'phase18-visual-smoke.json'
CASES = [
...
with sync_playwright() as pw:
  ...
  for name,layout,theme,width,height in CASES:
    ...
    if metrics['fileDocuments'] < 1 or metrics['fileSoftware'] < 1: failures.append('extension-specific file art missing')
...
print(f'OK: {len(results)} visual cases Phase 18')
