...
OUT = ROOT / 'docs' / 'screenshots' / 'phase17'
REPORT = ROOT / 'docs' / 'tests' / 'phase17-visual-smoke.json'
CASES = [
...
print(f'OK: {len(results)} visual cases Phase 17')
