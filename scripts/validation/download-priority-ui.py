...
try:
    with sync_playwright() as playwright:
        ...
        for theme, viewport in (
            ...
            if priority_rows.locator('> button').nth(0).evaluate("el => el.getBoundingClientRect().top") != priority_rows.locator('> button').nth(2).evaluate("el => el.getBoundingClientRect().top"):
...
print("OK: priority UI passed dark/light/small viewport, badges, radio semantics, keyboard focus, multiselect and clipping checks.")
