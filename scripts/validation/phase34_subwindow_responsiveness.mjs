...
const checks = [
  ...
  ['TikTok uses the provided full-content ICO asset', /media_social_tiktok_icon_124256\.ico/.test(source.subwindowJs) && !/host\.includes\('tiktok'\)\s*\?[^\n]*tiktok\.png/.test(source.subwindowJs)],
