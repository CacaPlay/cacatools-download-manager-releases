...
const checks = [
  ...
  ['Spotify multimedia se enruta y la captura HTTP directa permanece protegida', files.worker.includes('SPOTIFY_DIRECT_CAPTURE_MESSAGE') && files.host.includes('browser_download_capture') && files.bridge.includes('browser_download_capture') && files.main.includes("invoke('resolve_spotify_source'")]
];
