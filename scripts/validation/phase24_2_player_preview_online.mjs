...
const checks = [
  ...
  ['Spotify sigue desactivado y Native Messaging conserva el ID oficial', rust.includes('SPOTIFY_DISABLED_MESSAGE') && extensionBridge.includes('aonppfnabjnicjjeoofkfjofolfibggp')]
];
...
checks[checks.length - 1] = ['Spotify usa autenticación oficial y Native Messaging conserva el ID oficial', rust.includes('spotify_access_token') && extensionBridge.includes('aonppfnabjnicjjeoofkfjofolfibggp')];
