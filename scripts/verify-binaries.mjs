...
console.log('OK: yt-dlp, Deno, aria2c, FFmpeg y FFprobe presentes, ejecutables y con hashes coincidentes. Spotify/spotDL está desactivado y no se ejecuta en este gate.');
