// Vendored Lucide Icons 1.34.0 (ISC). Keep this small local subset in one
// source so preparation windows do not fall back to Unicode or CSS drawings.
const PATHS = Object.freeze({
  // Playlist brand mark: three list strokes with the blue play disc from
  // the supplied reference. Keeping it as one local vector avoids a
  // rasterized screenshot or a dependency on an external image URL.
  music: '<circle cx="3.8" cy="5.2" r="1.35" fill="currentColor" stroke="none"/><rect x="7" y="3.8" width="7.4" height="2.8" rx="1.4" fill="currentColor" stroke="none"/><circle cx="3.8" cy="12" r="1.35" fill="currentColor" stroke="none"/><rect x="7" y="10.6" width="6.3" height="2.8" rx="1.4" fill="currentColor" stroke="none"/><circle cx="3.8" cy="18.8" r="1.35" fill="currentColor" stroke="none"/><rect x="7" y="17.4" width="6.3" height="2.8" rx="1.4" fill="currentColor" stroke="none"/><circle cx="17" cy="12" r="4.35" fill="#4f9bff" stroke="none"/><path d="m15.65 9.8 3.55 2.2-3.55 2.2z" fill="#101a26" stroke="none"/>',
...
const ALIASES = Object.freeze({ playlist: 'music', http: 'link', close: 'x' });
