...
Este repositorio contiene las versiones públicas de Clear Download Manager:
instaladores, firmas, hashes, notas y metadatos de cada release.
...
La evidencia de la validación canary en un entorno Windows desechable queda
